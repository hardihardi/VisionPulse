  ...
  const renderVideoPlayer = () => {
    ...
    if (isAnalyzing) {
        if (mode === 'SIMULATION') {
            ...
            return (
                <div className="w-full h-full relative bg-black min-h-[300px] flex items-center justify-center">
                    <video ref={videoRef} src={videoSrc && videoSrc.endsWith('.m3u8') ? undefined : videoSrc} className="w-full h-full object-contain opacity-60" controls autoPlay loop muted />
                    <div className="absolute inset-0 bg-blue-500/10 pointer-events-none" />
